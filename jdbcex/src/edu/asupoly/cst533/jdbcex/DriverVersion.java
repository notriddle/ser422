/*
  ...
  USAGE: java edu.asupoly.cst533.jdbcex.DriverVersion <query> <url> <user> <passwd> <classname> [<classname>|...]

  Example:
  % java edu.asupoly.cst533.jdbcex.DriverVersion "select * from test1" "jdbc:postgresql://kgary1.east.asu.edu:5434/demo" demo cet4533 org.postgresql.Driver com.mysql.jdbc.Driver oracle.jdbc.driver.OracleDriver net.sourceforge.jtds.jdbc.Driver
...
Found driver: 0, 5
Executing query select * from test1 on URL jdbc:postgresql://kgary1.east.asu.edu:5434/demo
...
public class DriverVersion {
	...
	if (args.length < 5)
	    {
		System.out.println("USAGE: java edu.asu.cet591db.DriverVersion <query> <url> <user> <passwd> <classname> [<classname>|...]");
		System.exit(0);
	    }
